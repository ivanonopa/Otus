...
public class ATMImpl implements ATM {
    ...
    public ATMImpl(Map<Banknote, Integer> banknoteCells){
        this.banknoteCells= new HashMap<>(banknoteCells);
    }

    public ATMImpl(ATM atm) {
        this.banknoteCells = new HashMap<>(atm.getBanknoteCells());
    }
    ...
    public Map<Banknote,Integer> getBanknoteCells(){
        return banknoteCells;
    }

    public void setBanknoteCells(Map<Banknote, Integer> banknoteCells) {
